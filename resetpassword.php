...
if ($conn->connect_error) {
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
        ...
        if($password==$confirm_password){
            ...
            $sql = "UPDATE tbl_user SET password = '$hashed_password' WHERE email = '" . $_SESSION['email'] . "'";
...
<head>
    ...
    <title>LensPro - Reset Password</title>
...
<div class="logo-container">
     <img src="images/lenspro.png" alt="LensPro Logo">
    ...
    function checkPassword() {
        ...
        if (password === '') {
            ...
            passwordError.innerHTML = "Password must have atleast 8 characters with uppercase, lowercase, and a number.";
            passwordInput.style.border = "2px solid red";
            return false;
        } else {
